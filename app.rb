...
class Employee < ActiveRecord::Base
  has_many:courses # chceck class Course in relation to this
  self.primary_key = :id
...
class Course < ActiveRecord::Base
  self.primary_key = :id
  # if a course has an information about employee, then it belongs to employee
  belongs_to :employee
end
...
get '/show_course' do
  ...
  @employees = Employee.all # need all the employees to iteratie through ans retun
